...
public abstract class PreferenceFragment extends Fragment
  ...
  public void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    PreferenceManagerCompat.dispatchActivityResult(mPreferenceManager, requestCode, resultCode,
        data);
  }
  ...
  public void addPreferencesFromIntent(Intent intent) {
    ...
    setPreferenceScreen(PreferenceManagerCompat.inflateFromIntent(mPreferenceManager, intent,
        getPreferenceScreen()));
  }
  ...
  public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
    ...
    if (getActivity() instanceof OnPreferenceStartFragmentCallback) {
      return ((OnPreferenceStartFragmentCallback) getActivity()).onPreferenceStartFragment(this,
          preference);
    }
    return false;
  }
